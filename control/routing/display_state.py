"""Display-state tracking helpers for edge-based control.routing."""

from __future__ import annotations

import math

from model.display.display import ScreenBounds, normalize_position
from model.display.layouts import normalized_display_rect, resolve_display_for_normalized_point
