"""Tests for transport/peer/peer_server.py."""
...
def test_peer_server_sends_reject_frame_for_unknown_node(monkeypatch):
    ...
    monkeypatch.setattr(
        "transport.peer.peer_server.send_hello",
        lambda *_args, **_kwargs: None,
    )
    monkeypatch.setattr(
        "transport.peer.peer_server.recv_hello",
...
def test_peer_server_accepts_pending_join_unknown_node(monkeypatch):
    ...
    monkeypatch.setattr("transport.peer.peer_server.PeerConnection", FakePeerConnection)
